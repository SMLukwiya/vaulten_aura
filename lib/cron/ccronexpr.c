...
#define CRON_NUM_OF_DIGITS(num) (abs(num) < 10 ? 1 : (abs(num) < 100 ? 2 : (abs(num) < 1000 ? 3 : (abs(num) < 10000 ? 4 : (abs(num) < 100000 ? 5 : (abs(num) < 1000000 ? 6 : (abs(num) < 10000000 ? 7 : (abs(num) < 100000000 ? 8 : (abs(num) < 1000000000 ? 9 : 10)))))))))
...
static char *to_string(int num) {
    if (abs(num) >= CRON_MAX_NUM_TO_SRING)
        return NULL;
