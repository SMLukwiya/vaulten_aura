...
void aura_dmn_function_start(AURA_DBHANDLE db, struct aura_memory_ctx *mc, struct iovec *fn, int cli_fd) {
    ...
    app_debug(true, 0, "Function start fn meta key %s", key.base);
    ...
    aura_db_record_insert(db, A_DB_NS_FN, A_DB_SCHEMA_FN_STATE_V1, 0, 0, A_DB_OP_INSERT, state_key, state_data, A_DB_EXEC_ASYNC, &comp);
